...
public class Lab3FormatPhoneNumberWithForEach{
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        
        //String test = "A04.867.5309";
    ...
    * ****************************************/
    public static StringBuilder format(String pn){
         ...
         * since the dots in the right places test
         * has been passed (otherwise our program would have
         * failed before we got here we don't have to worry about checking dot
         * positions only that all characters are dots or digits.
         */
